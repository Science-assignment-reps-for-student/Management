...
class personal_homework(Resource):
    def get(self):
            ...
            res.append(
                {
                    ...
                    "class_1": {
                        "deadline": time.mktime(
                            personal_homework.homework_1_deadline.timetuple()
                        ),
                        "submit_list": c_1,
                    },
                    "class_2": {
                        "deadline": time.mktime(
                            personal_homework.homework_2_deadline.timetuple()
                        ),
                        "submit_list": c_2,
                    },
                    "class_3": {
                        "deadline": time.mktime(
                            personal_homework.homework_3_deadline.timetuple()
                        ),
                        "submit_list": c_3,
                    },
                    "class_4": {
                        "deadline": time.mktime(
                            personal_homework.homework_4_deadline.timetuple()
                        ),
                        "submit_list": c_4,
                    },
                }
        ...
        return {"homework_type": 0, "homework_info": res}, 200
