...
from tenderloin.app.services import user_type_checker, jwt_checker
...
from tenderloin.app.models.multifiles import MultifileModel
from tenderloin.app.models.user import UserModel
from tenderloin.app.models.team import TeamModel
from tenderloin.app.models.members import MemberModel
from tenderloin.app.models.self_ev import SelfevaluationModel
from tenderloin.app.models.mutual_ev import MutualevaluationModel
...
class experiment_homework(Resource):
    def get(self):
        ...
        for experiment in experiments:
            ...
            for user in users:
                s_evaluation = SelfevaluationModel.query.filter(
                    and_(
                ...
                m_evaluations = MutualevaluationModel.query.filter(
                    and_(
                ...
                for l_1 in l_1_a:
                    ...
                    if t_1.homework_id == experiment.id:
                        member_count = MemberModel.query.filter_by(
                            team_id=t_1.id
                        ).count()
                        break
            ...
            for team in teams:
                ...
                for team_info in team_infos:
                    member_info = UserModel.query.filter_by(
                        id=team_info.user_id
                    ).first()
                    member.append(
                        {
            ...
            res.append(
                {
                    ...
                    "class_1": {
                        "deadline": time.mktime(
                            experiment.homework_1_deadline.timetuple()
                        ),
                    ...
                    "class_2": {
                        "deadline": time.mktime(
                            experiment.homework_2_deadline.timetuple()
                        ),
                    ...
                    "class_3": {
                        "deadline": time.mktime(
                            experiment.homework_3_deadline.timetuple()
                        ),
                    ...
                    "class_4": {
                        "deadline": time.mktime(
                            experiment.homework_4_deadline.timetuple()
                        ),
        ...
        return {"homework_type": 1, "homework_info": res}, 200
