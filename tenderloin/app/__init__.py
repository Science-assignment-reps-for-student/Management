...
def register_extension(flask_app: Flask):
    from tenderloin.app import extension
...
def register_blueprint(flask_app: Flask):
    from tenderloin.app.views.apis.info.personal import assignment

    flask_app.register_blueprint(assignment.api.blueprint)

    from tenderloin.app.views.apis.info.team import team_assignment, experiment
